...
% ------------------------------------------------------------------
1. Os cursos de Ciência da Computação e Inteligência Artificial compartilham
  disciplinas como Estruturas de Dados, POO, Teoria dos Grafos e Algoritmos, além
  do mesmo corpo docente, laboratórios e acesso ao PPGCC. Um estudante argumenta que, diante disso, manter dois cursos separados é \ntc{redundante e ineficiente}. Avalie criticamente esse argumento considerando tanto os pontos que o \impt{sustentam} quanto os que o \impt{contradizem}.

\answerlines{32}


2. As universidades federais funcionam sobre três pilares básicos: Ensino, Pesquisa e Extensão. Discuta o papel da universidade na sociedade sob o ponto de vista de cada pilar.
